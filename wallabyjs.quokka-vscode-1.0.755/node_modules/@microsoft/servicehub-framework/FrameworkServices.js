...
exports.FrameworkServices = void 0;
const constants_1 = require("./constants");
const ServiceJsonRpcDescriptor_1 = require("./ServiceJsonRpcDescriptor");
const ServiceMoniker_1 = require("./ServiceMoniker");
/**
 * Exposes common RPC descriptors to be used with service brokers
 */
let FrameworkServices = /** @class */ (() => {
     ...
     */
    FrameworkServices.remoteServiceBroker = Object.freeze(new ServiceJsonRpcDescriptor_1.ServiceJsonRpcDescriptor(ServiceMoniker_1.ServiceMoniker.create('RemoteServiceBroker'), constants_1.Formatters.Utf8, constants_1.MessageDelimiters.HttpLikeHeaders));
    /**
     ...
     */
    FrameworkServices.authorization = Object.freeze(new ServiceJsonRpcDescriptor_1.ServiceJsonRpcDescriptor(ServiceMoniker_1.ServiceMoniker.create('Microsoft.ServiceHub.Framework.AuthorizationService'), constants_1.Formatters.Utf8, constants_1.MessageDelimiters.HttpLikeHeaders));
    return FrameworkServices;
})();
exports.FrameworkServices = FrameworkServices;
...
// SIG // OYgeQWtMqV34QWFDUi4uz/vhdHN5aJ3QDUvzc75LPUig
...
// SIG // BAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJOnCkMxNunyh
// SIG // IktkjFazgrA5jUMXlTm/F+ZU7n/w7mEwQgYKKwYBBAGC
// SIG // NwIBDDE0MDKgFIASAE0AaQBjAHIAbwBzAG8AZgB0oRqA
// SIG // GGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTANBgkqhkiG
// SIG // 9w0BAQEFAASCAQAf88tZXtTz0UWJGz3rM9jxBbmgQT0l
// SIG // NFJbunb6ql06BIDXfgL9SP4nCMXyzZJX0RAFwsATgYFD
// SIG // 8MGhBFQTQpvgQ22wQSi2IvIrxzQO0VV6O3px4n+mZZ7C
// SIG // FO37yfNmKWU+eDuCB5Cps34XMB05JTujZkJkGcP8kKyb
// SIG // ac6XuIHo84ZQoes4H5CQZQQVlJ1TWMeNtrHNniMGYCNm
// SIG // 6+gRz7mUegewiysy13DKei91DE8kOHpEaBB+TjwcmybX
// SIG // zwLri4EooGwMapGDyO4d/6L6g5WCHVBmABo3byiElfVz
// SIG // zhyce9JehUfRicCQ/cgToBj3y91iVkDtWZGd1m/C+K4E
// SIG // tE+1oYIS5TCCEuEGCisGAQQBgjcDAwExghLRMIISzQYJ
...
// SIG // IEvbHAZ6B6duGPehJY+1DNNFVLsliRUeGxhOHF9xERfD
// SIG // AgZe1lPxPFMYEzIwMjAwNjExMTg0NTI1LjU5NFowBIAC
...
// SIG // hkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgzFg6iTx0
// SIG // XJOSJLDtkGP5/VvSPjZNQh1QBMLGqmdsjdMwgfoGCyqG
...
// SIG // AKrG4qspYp8ygmv2ytSKMdR3q8g8+dkFGCAcnRMTYLDL
// SIG // 8D+LmHc2DSwVuwH/ggM04Zj37xmOk0e6Ws78ae6vJTPz
// SIG // unePixR0oyWf05/mHHP40ScIKuPaas8oLotFh81NnBoo
// SIG // WZaBcPLeA9rPz7RJ1PHrTzP4kOzuNQoBKsij70puN4k/
// SIG // 3zUhjOrwwlKzk86HMAuMvxTqQnNZnpU0hvytW6kmpLdp
// SIG // wS2tfa7dY33X8T+uH66P3fsuGK2SfNGbcooqS4a+UN5M
// SIG // MezPVnV11bFbyXdz8cg5ad5Fc6Cg7mw30tiZZufIeQ6X
// SIG // LOm3UggLzCX4ZqCsty/HII2C6ElkTwUXOjc=
